...
macs_h3k27me3_sc_ol <- findOverlapsOfPeaks(
  granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-biological.macs2.nolambda_peaks`,
  granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-rmDup.macs2.nolambda_peaks`,
  granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-withDups.macs2.nolambda_peaks`,
  h3k27me3_encode_gr,
  maxgap = 10000,
...
macs_h3k27me3_list  <- list(
  "Biological" = granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-biological.macs2.nolambda_peaks`,
  "No_Duplicates" = granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-rmDup.macs2.nolambda_peaks`,
  "All_Reads" = granges_list$H3K27me3$`okur_H3K27me3-batch37_R1-withDups.macs2.nolambda_peaks`,
...
macs_rad21_list <- list(
  "Biological" = granges_list$RAD21$`NTC_RAD21-batch61_A-biological.macs2.nolambda_peaks`,
  "No_Duplicates" = granges_list$RAD21$`NTC_RAD21-batch61_A-rmDup.macs2.nolambda_peaks`,
  "All_Reads" = granges_list$RAD21$`NTC_RAD21-batch61_A-withDups.macs2.nolambda_peaks`)
