...
# Set paths
ref="/scratch/g/srrao/aray/AR_CUT_TAG/Mus_musculus/UCSC/mm10/Sequence/Bowtie2Index/genome"
...
# Get list of samples
SAMPLES=($(ls Trim_cutadapt_M*.1.fastq | sed 's/Trim_cutadapt_//' | sed 's/\.1\.fastq//' | uniq))
